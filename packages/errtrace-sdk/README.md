...
This is the final, complete documentation that covers **everything**—from initial setup to advanced SDK usage and subpath exports. You can drop it straight into your `README.md` and it’s ready to go.